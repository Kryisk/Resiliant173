    ...
    implements Runnable
{
                    ...
                    } else
                    {
                        ...
                        } else
                        {
                            ...
                            if(Keyboard.getEventKey() == 54) {
                         	 	displayGuiScreen(new GuiMod(currentScreen));
                         }
    ...
    public static void startMainThread(String s, String s1, String s2)
    {
    	...
    	//TODO: Main begining of game, where the title is stored
    	
        boolean flag = false;
        String s3 = s;
        Frame frame = new Frame(Resiliant.getClient_name() + " " + Resiliant.getClient_version());
