...
public class Block
{
    ...
    {
    	if( blockID == 54 || blockID == 14 || blockID == 15 || blockID == 57 || blockID == 56) {
    		return 0;
    	}
        return 0;
    }
    ...
    private static float bight;
    public float getBlockBrightness(IBlockAccess iblockaccess, int i, int j, int k)
    
    {
    	if(Resiliant.modulemanager.getModule(Fullbright.class).getState() || Resiliant.modulemanager.getModule(jvision.class).getState()) {
    		   return 1F;
    	}
    ...
    {
    	     	if (Resiliant.modulemanager.getModule(jvision.class).getState()) {
    	     		return blockID == 54 || blockID == 14 || blockID == 15 || blockID == 57 || blockID == 56;
    	     	}
////            int[] renderBlacklist = jvision.blockList;
////            int length = renderBlacklist.length;
////            if (length == 0) {
////                return false;
////            }
////            for (int i2 = 0; i2 < length; i2++)
////            {
////                if (renderBlacklist[i2] == this.blockID) {
////                    return true;
////                }
////            }
//        }
...
//    		 return 1;
//    	 }
//        return !Resiliant.modulemanager.getModule(jvision.class).getState() ||  blockID == 54 || blockID == 14 || blockID == 15 || blockID == 57 || blockID == 56? 0 : 1;
    	return 0;
    }
