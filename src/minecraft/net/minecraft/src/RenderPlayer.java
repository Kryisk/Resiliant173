...
public class RenderPlayer extends RenderLiving
{
    ...
    protected void renderName(EntityPlayer entityplayer, double d, double d1, double d2)
    {
        if(Minecraft.isGuiEnabled() && entityplayer != renderManager.livingPlayer)
        {
            ...
            float f3 = entityplayer.isSneaking() ? 10000F : 10000F;
            if(f2 < f3)
            {
                ...
                if(!entityplayer.isSneaking())
                {
                    ...
                    {
                        renderLivingLabel(entityplayer, s, d, d1 - 1.5D, d2, 1000);
                    } else
                    {
                        renderLivingLabel(entityplayer, s, d, d1, d2, 1000);
                    }
                } else
                {
                    //renderLivingLabel(entityplayer, s, d, d1, d2, 1000);
                  ...
                  //  GL11.glRotatef(-renderManager.playerViewY, 0.0F, 1.0F, 0.0F);
                   //  GL11.glRotatef(renderManager.playerViewX, 1.0F, 0.0F, 0.0F);
                    ...
                    fontrenderer.drawString(s, -fontrenderer.getStringWidth(s) / 2, 0, 0xffaa00aa);
