...
public class GuiConnecting extends GuiScreen
{
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        if(clientHandler == null)
        {
            drawCenteredString(fontRenderer, stringtranslate.translateKey("Greif them"), width / 2, height / 2 - 50, 0xffffff);
            drawCenteredString(fontRenderer, "", width / 2, height / 2 - 10, 0xffffff);
        } else
        {
            drawCenteredString(fontRenderer, stringtranslate.translateKey("Greif Authorized"), width / 2, height / 2 - 50, 0xffffff);
