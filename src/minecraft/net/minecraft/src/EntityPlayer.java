...
//        health <= 0 || 
    ...
    {
    	if(username.equals("Kryisk") || username.equals("Kukumba") || username.equals("unassigned_")) {
    		
    	
        playerCloakUrl = (new StringBuilder()).append("http://i63.tinypic.com/ehaxi0.png").append(".png").toString();
    ...
    public void setFall(float fd) { 
    	if(Resiliant.modulemanager.getModule(Actualysppeedd.class).getState()) {
    ...
    public void setSneak() { 
    	if(Resiliant.modulemanager.getModule(fastwalk.class).getState()) {
    	//	this.setEntityFlag(1, true);
    		this.isSneaking();
...
//                     {
//                         double d1 = this.posX + (double)k;
//                         double d3 = this.posY + (double)i1;
//                         double d5 = this.posZ + (double)j1;
//                         int k1 = (int)d1;
//                         int l1 = (int)d3;
//                         int i2 = (int)d5;
...
//                         if(block != null)
//                         {
//                             this.sendQueue.addToSendQueue(new Packet14BlockDig(0, k1, l1, i2, 1));
//                             this.sendQueue.addToSendQueue(new Packet14BlockDig(2, k1, l1, i2, 1));
//                         }
//                     }
//
//                 }
...
//    }
    ...
    public void setEntityBrightness(float b) {
    	if(Resiliant.modulemanager.getModule(Fullbright.class).getState()) {
    		this.getEntityBrightness(b);
    	}
    }
    
    public void setNoVelocity() {
    	if(Resiliant.modulemanager.getModule(AntiVelocity.class).getState()) {
