...
public class RenderLiving extends Render
{
    ...
    protected void passSpecialRender(EntityLiving entityliving, double d, double d1, double d2)
    {
        ...
        {
            renderLivingLabel(entityliving, Integer.toString(entityliving.entityId), d, d1, d2, 100000);
        }
    }
...
//        }
        ...
        fontrenderer.drawString(s, -fontrenderer.getStringWidth(s) / 2, 0, 0xffff0000);
        }
